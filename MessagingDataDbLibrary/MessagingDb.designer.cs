...
namespace MessagingDataDbLibrary
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="AlphaImDb")]
    ...
    partial void DeleteUSER(USER instance);
		...
		public MessagingDbDataContext() : 
				base(global::MessagingDataDbLibrary.Properties.Settings.Default.AlphaImDbConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnUSR_CONTACTChanged();
		...
		[Association(Name="USER_CONTACTLIST", Storage="_USER", ThisKey="USR_CONTACT", OtherKey="ID_USR", IsForeignKey=true)]
		public USER USER
		{
			get
			{
		...
		[Association(Name="USER_CONTACTLIST1", Storage="_USER1", ThisKey="USR_MAIN", OtherKey="ID_USR", IsForeignKey=true)]
		public USER USER1
		{
			get
			{
    ...
    partial void OnM_USERChanged();
		...
		[Association(Name="GROUP_USERSOFGROUP", Storage="_USERSOFGROUPs", ThisKey="ID_GROUP", OtherKey="ID_GROUP")]
    ...
    partial void OnC_DATEChanged();
		...
		[Association(Name="MESSAGE_MESSTOUSR", Storage="_MESSTOUSRs", ThisKey="ID_MESSAGE", OtherKey="ID_MESSAGE")]
    ...
    partial void OnID_GROUPChanged();
		...
		[Association(Name="GROUP_USERSOFGROUP", Storage="_GROUP", ThisKey="ID_GROUP", OtherKey="ID_GROUP", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public GROUP GROUP
		{
			get
			{
		...
		[Association(Name="USER_USERSOFGROUP", Storage="_USER", ThisKey="ID_USR", OtherKey="ID_USR", IsForeignKey=true)]
		public USER USER
		{
			get
			{
    ...
    partial void OnMSG_STATEChanged();
		...
		[Association(Name="MESSAGE_MESSTOUSR", Storage="_MESSAGE", ThisKey="ID_MESSAGE", OtherKey="ID_MESSAGE", IsForeignKey=true)]
		...
		[Association(Name="USER_MESSTOUSR", Storage="_USER", ThisKey="ID_SENDER", OtherKey="ID_USR", IsForeignKey=true)]
		public USER USER
		{
			get
			{
		...
		[Association(Name="USER_MESSTOUSR1", Storage="_USER1", ThisKey="ID_USR", OtherKey="ID_USR", IsForeignKey=true)]
		public USER USER1
		{
			get
			{
	...
	public partial class USER : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<System.DateTime> _USR_LASTACTIVITY;
    ...
    partial void OnM_USERChanged();
    partial void OnUSR_LASTACTIVITYChanging(System.Nullable<System.DateTime> value);
    partial void OnUSR_LASTACTIVITYChanged();
    #endregion
		...
		[Column(Storage="_USR_EMAIL", DbType="VarChar(150)")]
		...
		[Column(Storage="_M_USER", DbType="Int")]
		...
		[Column(Storage="_USR_LASTACTIVITY", DbType="DateTime")]
		public System.Nullable<System.DateTime> USR_LASTACTIVITY
		{
			get
			{
				return this._USR_LASTACTIVITY;
			}
			set
			{
				if ((this._USR_LASTACTIVITY != value))
				{
					this.OnUSR_LASTACTIVITYChanging(value);
					this.SendPropertyChanging();
					this._USR_LASTACTIVITY = value;
					this.SendPropertyChanged("USR_LASTACTIVITY");
					this.OnUSR_LASTACTIVITYChanged();
				}
			}
		}
		
		[Association(Name="USER_CONTACTLIST", Storage="_CONTACTLISTs", ThisKey="ID_USR", OtherKey="USR_CONTACT")]
		...
		[Association(Name="USER_CONTACTLIST1", Storage="_CONTACTLISTs1", ThisKey="ID_USR", OtherKey="USR_MAIN")]
		...
		[Association(Name="USER_USERSOFGROUP", Storage="_USERSOFGROUPs", ThisKey="ID_USR", OtherKey="ID_USR")]
		public EntitySet<USERSOFGROUP> USERSOFGROUPs
		{
			get
			{
		...
		[Association(Name="USER_MESSTOUSR", Storage="_MESSTOUSRs", ThisKey="ID_USR", OtherKey="ID_SENDER")]
		public EntitySet<MESSTOUSR> MESSTOUSRs
		{
			get
			{
		...
		[Association(Name="USER_MESSTOUSR1", Storage="_MESSTOUSRs1", ThisKey="ID_USR", OtherKey="ID_USR")]
